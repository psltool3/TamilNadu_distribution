...
<html lang="en">
    <head>
		...
		<script> var pythonUrl = "https://bsfcsmartroutes.in/api/"; var directory = "" </script>
    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Tamil Nadu State Level</span>
