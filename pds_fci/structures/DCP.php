...
class DCP {
	...
	function insert(DCP $dcp){
        return "INSERT INTO dcp (district, name, id, type, latitude, longitude, demand,demand_rice,demand_frice, uniqueid, active) VALUES ('".$dcp->getDistrict()."','".$dcp->getName()."','".$dcp->getId()."','".$dcp->getType()."','".$dcp->getLatitude()."','".$dcp->getLongitude()."','".$dcp->getDemand()."','".$dcp->getDemandrice()."','".$dcp->getDemandfrice()."','".$dcp->getUniqueid()."','".$dcp->getActive()."')";
    }
    ...
    function update(DCP $dcp){
     return  "UPDATE dcp SET district = '".$dcp->getDistrict()."',name = '".$dcp->getName()."',id = '".$dcp->getId()."',type = '".$dcp->getType()."',latitude = '".$dcp->getLatitude()."',longitude = '".$dcp->getLongitude()."',demand = '".$dcp->getDemand()."',demand_rice = '".$dcp->getDemandrice()."', demand_frice = '".$dcp->getDemandfrice()."' WHERE uniqueid = '".$dcp->getUniqueid()."'";
    }
