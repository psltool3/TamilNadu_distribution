...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Tamil Nadu PDS Route Optimization</li>
</ul>
<!-- END BREADCRUMB -->
<div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Tamilnadu PDS Route Optimization</h1>
					<h1 style="font-weight: bold; color: #FF6666;">Kindly optimizised the Leg2-Warehouse to FPS</h1>
							...
							<div class="row">
								<div class="col-md-4 mb-4">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total State Warehouse</div>
									</div>
								</div>
								<div class="col-md-4 mb-4">
									<div class="card h-100"
								...
								<div class="col-md-3 mb-3">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total FPS Demands Rice (Qtl)</div>
									</div>
								</div>
								<div class="col-md-3 mb-3">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total FPS Demands FRice (Qtl)</div>
									</div>
								</div>
								<div class="col-md-3 mb-3">
									<div class="card h-100"
						...
						.then(data => {
							...
							fetch(pythonUrl + 'getfcidata', {
								...
								.then(data => {
									...
									document.getElementById("total_demand_frice").innerHTML = formatNumberWithCommasWithoutDecimal(data["Total_Demand_FRice"]);
...
function downloadExcelFile() {
    ...
    a.href = url;
    a.download = 'Template_SCO_IntraState_tamilnadu.xlsx';
    a.click();
...
function downloadFile(fileType) {
    ...
    if (fileType === 'xlsx') {
        filePath = 'template/Template_SCO_IntraState_tamilnadu.xlsx';
        fileName = 'Template_SCO_IntraState_tamilnadu.xlsx';
    } else if (fileType === 'pdf') {
        filePath = 'template/Template_SCO_IntraState_tamilnadu.pdf';
        fileName = 'Template_SCO_IntraState_tamilnadu.pdf';
    }
	...
	if (checkbox.checked) {
		...
		fetch(pythonUrl + 'getGraphData', {
			...
			.then(data => {
				...
				var totalDemandFRice = Object.values(data.District_Demand_FRice).reduce((acc, demand) => acc + demand, 0);
				var totalDemand = totalDemandWheat + totalDemandRice + totalDemandRice;


				console.log("Total demand for wheat:", totalDemandWheat);
				console.log("Total demand for rice:", totalDemandRice);
				console.log("Total demand for frice:", totalDemandFRice);
				...
				if (totalCapacity > 0 && totalDemand > 0) {
					...
					var newData = {
						...
						datasets: [
							...
							{
								label: 'Rice Demand',
								backgroundColor: '#b3db86',
								data: demands_rice
							},
							{
								label: 'FRice Demand',
								backgroundColor: '#c64a44',
								data: demands_frice
							},
							{
								label: 'Supply',
