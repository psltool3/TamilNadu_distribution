...
if (!preg_match('/^FPS_[a-zA-Z0-9]+$/', $_POST["uid"])) {
                             ...
                             <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Full Time FPS/ Part Time FPS</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
												   <span class="input-group-addon"><span class="fa fa-arrow-down"></span></span>
                                                    ...
                                                    <span class="help-block">Full Time FPS/ Part Time FPS</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Entitlement of Wheat in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="demand" name="demand" value="<?php echo $demand ?>" required />
                                                    </div>
                                                    <span class="help-block">Entitlement in Quintals</span>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-3 control-label">Entitlement of Rice in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Entitlement of FRice in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
