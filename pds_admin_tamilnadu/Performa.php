...
<style>
    ...
    /* Optional: Font size for table header */
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Performa Leg2</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
								<h3 class="panel-title">Performa Leg2</h3>
							</div>
                                 ...
                                 <div class="table-responsive">
                                    ...
                                    <table id="export_table" class="table">
										...
										while($row_table = mysqli_fetch_assoc($result_table)){
											...
											$reset = "<input class='btn btn-info btn-block' style='width:25%' onclick='resetFunction(\"".$id."\")' value='Reset'></input>";
											
											if($cost==null or $cost==""){
												$temp = "cost_".$id;
												$cost = "<input type='number' id='".$temp."' name='".$temp."' min='0' step='any' style='width:120px' required />";
												$reset = "";
											}											
