...
if (isset($_POST['id_approve']) && $_POST['id_approve'] !== "") {
    ...
    if ($id_approve == "yes" || $id_approve == "no") {
        ...
        writeLog("User -> Save Row Data | approve district change $id_approve -> " . $user . " | " . $fromid . " - " . $toid . " - " . $commodity);
    }
}
...
if (isset($_POST['approve_bool']) && $_POST['approve_bool'] !== "") {
    ...
    if ($approve_bool == "yes") {
        ...
        writeLog("User -> Save Row Data | approve admin change yes -> " . $user . " | " . $fromid . " - " . $toid . " - " . $commodity);
        ...
        mysqli_query($con, $updateQuery);
        writeLog("User -> Save Row Data | approve admin change no -> " . $user . " | " . $fromid . " - " . $toid . " - " . $commodity);
        ...
        mysqli_query($con, $updateQuery);
        writeLog("User -> Save Row Data | approve district change id -> " . $user . " | " . $fromid . " - " . $toid . " | " . $new_id_admin);
    }
}
