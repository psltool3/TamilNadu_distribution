                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                ...
                                <a href="api/SmartFPSStatus.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Part Time FPS Status Change</button></a>
								<a href="api/NonSmartFPSStatus.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Full Time FPS Status Change</button></a>
								</div>
