...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Tamil Nadu PDS Route Optimisation</li>
</ul>
<!-- END BREADCRUMB -->
<div>
							...
							<div class="row">
								...
								<div class="col-md-3 mb-3">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total Rice Required (Qtl)</div>
									</div>
								</div>
								<div class="col-md-3 mb-3">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total FRice Required (Qtl)</div>
									</div>
								</div>
								<div class="col-md-3 mb-3">
									<div class="card h-100"
					...
					<div
						...
						<div class="card">
							<div class="row">
								...
								<center style="margin-top:20px">
									<h4><b id="totalFciDemandRice"></b></h4>
								</center>
								<center style="margin-top:20px">
									<h4><b id="totalFciDemandFRice"></b></h4>
								</center>
								<center style="margin-top:20px">
...
<script>
	...
	var initialData = {
		labels: ['Chennai', 'Madurai', 'Tirunelveli', 'Coimbatore', 'Tiruchirappalli'],
		datasets: [{
			label: 'Supply',
		...
		$.ajax({
			...
			success: function(result){
				...
				try{
					...
					document.getElementById("totalFciDemandFRice").innerHTML = "";
