...
<script>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
								<div class="panel-heading">
                                    <h3 class="panel-title">Tamil Nadu Route Optimisation For PDS <div id="timer"> <b>Time Left &nbsp </b> <span id="countdown"></span></h3>
                                </div>
                            </div>
							<div class="row">
    ...
    <!-- START SCRIPTS -->
		...
		function fetchDataFromServerId(){
			...
			var dataString = 'approved='+ approved + '&fromid=' + from_id + '&district=' + district + '&toid=' + to_id;
			if(dataString=='')
			{
